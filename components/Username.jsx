...
const Username = ({ user, formData, setFormData, inputs }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const res = await fetch("/api/settings/?endpoint=patchUpdateUsername", {
      method: "PATCH",
      body: JSON.stringify({ id: user._id, newUsername: newUsername }),
